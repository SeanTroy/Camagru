...
<body>
		...
		<div class="preview_area">
			...
			<div class="stickerbar">
				<div class="stickerbar_content">
					<img class="sticker" id="nosticker" src="stickers/empty.png" onclick="chooseSticker(this,0,0,0,0)">
					<img class="sticker" id="42.png" src="stickers/42.png" onclick="chooseSticker(this,30,30,180,110)">
					<img class="sticker" id="Skullandbones.png" src="stickers/Skullandbones.png" onclick="chooseSticker(this, 90, 0, 480, 480)">
				</div>
			</div>
		</div>
	...
	<form>
		<input type="text" id="selected_sticker" value="42.png,30,30,220,134" hidden>
	</form>
...
<script type='text/Javascript'>
	...
	function chooseSticker(sticker, h_offset, v_offset, width, height) {
		/* enable the take photo button */
		if (sticker.id == "nosticker")
